...
import type { ActionFormField } from './action-form-overlay';
...
async function actionForm(action: ActionView, fields: ActionFormField[]): Promise<Record<string, unknown> | null> {
  const { ActionFormOverlay } = await import('./action-form-overlay');
  return new Promise(resolve => {
    ...
    renderView(<ActionFormOverlay title={actionTitle(action)} fields={fields} initialTarget={selectedTargetId} onClose={close} />, backdrop);
  });
}
